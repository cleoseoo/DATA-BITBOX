...
(function(){
    ...
    const PARTICLE_POOL = {
        '1': { words: ['데이터','아날로그','디지털','인공지능','센서','문자','이미지','소리'], bins:  ['0','1','00','11','01','10'], colors: ['#00f5c4','#00cec9','#55efc4','#b2fff0'] },
        '2': { words: ['비트','바이트','1KB','1MB','1GB','8bit','용량'], bins:  ['00000000','11111111','01010101','10101010','00001000'], colors: ['#00f5c4','#00b894','#81ecec','#a8e6cf'] },
        '3': { words: ['2진수','10진수','진법변환','자릿값','255','128','64'], bins:  ['00000111','00101010','11111111','00000000','00001010'], colors: ['#fdcb6e','#f9ca24','#f0932b','#ffeaa7'] },
        '4': { words: ['ASCII','유니코드','UTF-8','가','A','인코딩','이모지'], bins:  ['01000001','01000010','01100001','01000011','01100010'], colors: ['#5ac8fa','#74b9ff','#0984e3','#a8d8ea'] },
        '5': { words: ['픽셀','해상도','RGB','비트심도','계단현상','비트맵','벡터'], bins:  ['11111111','00000000','11110000','00001111','10101010'], colors: ['#d08ef7','#a29bfe','#6c5ce7','#e8c4ff'] },
        '6': { words: ['표본화','양자화','부호화','PCM','파형','Hz','샘플링'], bins:  ['10110100','01001011','11001100','10001000','01110111'], colors: ['#fd79a8','#e84393','#ff7675','#fab1c3'] },
        '7': { words: ['프레임','fps','잔상효과','코덱','압축','스트리밍','동영상'], bins:  ['00011000','00010000','11000000','00001111','10000001'], colors: ['#487eb0','#74b9ff','#0652DD','#a8c4e0'] }
    };
